...
Examples:
  ...
  python sanitize_mermaid_2.py

  # Pipe from stdin
  cat diagram.mmd | python sanitize_mermaid_2.py

  # Read from file, overwrite same file
  python sanitize_mermaid_2.py diagram.mmd

  # Read from input file, write to output file
  python sanitize_mermaid_2.py input.mmd output.mmd

  # Specify Windows-style line endings
  python sanitize_mermaid_2.py --line-ending crlf diagram.mmd
        """
    )
