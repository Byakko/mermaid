...
# Gantt chart parsing has been moved to mermaid_to_python_converters/mtp_gantt.py
# _GANTT_STATUS_KEYWORDS = {'done', 'active', 'crit', 'milestone', 'vert'}
# def _extract_gantt_task_statuses(parts: list) -> tuple: ...
# def _classify_gantt_task_part(...) -> dict: ...
# def _resolve_gantt_start(...) -> Union[str, DateRange]: ...
...
def parse_mermaid_text(text: str, line_ending: LineEnding) -> Optional[Union[
    ...
    parsers = {
        ...
        # "gantt": parse_gantt,  # Moved to mermaid_to_python_converters/mtp_gantt.py
        "pie": parse_pie_chart,
